...
META = [
    dict(id='kaznu', code='ALA·KZNU', short='КазНУ', name='Казахский национальный университет имени аль-Фараби', city='Алматы', type='national', website='https://farabi.university', postcard='almaty', langs=['kz', 'ru', 'en'], dorm=True),
    ...
    dict(id='enu', code='NQZ·ENU', short='ЕНУ', name='Евразийский национальный университет имени Л. Н. Гумилёва', city='Астана', type='national', website='https://enu.kz', postcard='astana', langs=['kz', 'ru', 'en'], dorm=True),
    ...
    dict(id='kargu', code='KGF·KARU', short='КарУ Букетова', name='Карагандинский университет имени академика Е. А. Букетова', city='Караганда', type='state', website='https://buketov.edu.kz', postcard='karaganda', langs=['kz', 'ru'], dorm=True),
    dict(id='kaznmu', code='ALA·KNMU', short='КазНМУ', name='Казахский национальный медицинский университет имени С. Д. Асфендиярова', city='Алматы', type='national', website='https://kaznmu.edu.kz', postcard='almaty', langs=['kz', 'ru'], dorm=True),
    dict(id='sku', code='CIT·SKU', short='ЮКУ Ауэзова', name='Южно-Казахстанский университет имени М. Ауэзова', city='Шымкент', type='state', website='https://auezov.edu.kz', postcard='shymkent', langs=['kz', 'ru'], dorm=True),
    ...
    dict(id='kaznpu', code='ALA·KNPU', short='КазНПУ', name='Казахский национальный педагогический университет имени Абая', city='Алматы', type='national', website='https://abaiuniversity.edu.kz', postcard='almaty', langs=['kz', 'ru'], dorm=True),
    ...
    dict(id='kazatu', code='NQZ·KATU', short='КазАТУ', name='Казахский агротехнический исследовательский университет имени С. Сейфуллина', city='Астана', type='state', website='https://kazatu.edu.kz', postcard='astana', langs=['kz', 'ru'], dorm=True),
    dict(id='kartu', code='KGF·KTU', short='КарТУ', name='Карагандинский технический университет имени Абылкаса Сагинова', city='Караганда', type='state', website='https://kstu.kz', postcard='karaganda', langs=['kz', 'ru'], dorm=True),
    ...
    dict(id='toraighyrov', code='PWQ·TOU', short='Торайгыров ун-т', name='Торайгыров университет (Павлодар)', city='Павлодар', type='state', website='https://tou.edu.kz', postcard='default', langs=['kz', 'ru'], dorm=True),
    dict(id='vktu', code='UKK·EKTU', short='ВКТУ', name='Восточно-Казахстанский технический университет имени Д. Серикбаева', city='Усть-Каменогорск', type='state', website='https://ektu.kz', postcard='default', langs=['kz', 'ru'], dorm=True),
    dict(id='kru', code='KSN·KRU', short='КРУ Байтурсынова', name='Костанайский региональный университет имени Ахмет Байтұрсынұлы', city='Костанай', type='state', website='https://kru.edu.kz', postcard='default', langs=['kz', 'ru'], dorm=True),
    dict(id='argu', code='AKX·ARU', short='АРУ Жубанова', name='Актюбинский региональный университет имени К. Жубанова', city='Актобе', type='state', website='https://aru.edu.kz', postcard='default', langs=['kz', 'ru'], dorm=True),
]
